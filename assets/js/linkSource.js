...
function acdDB(){
	idtab = "academic";
    hdr = "Academic";
    para = "Terkhusus kamu yang membutuhkanayau mencari tautan alamat situs yang menyediakan berbagai referensi akademik seperti jurnal ilmiah dan penelitian, kamu bisa mengakses beberapa tautan lokal yang telah kami himpun dibawah ini.";
	arrDB = [
